...
import api, { adminIncidentsAPI, adminTeamsAPI } from '../services/api';
...
function AdminDashboard() {
    ...
    useEffect(() => {
        fetchSummary();
        fetchTeams();
        fetchDonations(); // Ensure donations are fetched for calculation
    }, []);
    ...
    // Calculate total donations from donations list
    ...
    return (
        <Container fluid className="admin-dashboard-bg py-4">
            <Row className="mb-4">
                <Col>
                    <div className="admin-header-bar d-flex align-items-center justify-content-between mb-3 p-3 rounded shadow">
                        <div className="d-flex align-items-center">
                            
                            <h1 className="text-white mb-0">Admin Dashboard</h1>
                        </div>
                        <span className="badge bg-gradient-primary fs-5 px-3 py-2">System Overview</span>
                    </div>
            ...
            <Row className="mb-4 g-4">
                <Col md={3} className="mb-3">
                    <Card className="text-center h-100 admin-card-gradient border-0 shadow-lg rounded-4">
                        <Card.Body>
                            <div className="text-danger mb-2">
                                <i className="bi bi-people-fill" style={{ fontSize: '2.5rem' }}></i>
                            </div>
                            <Card.Title className="h2 text-danger fw-bold">{summary?.userCount}</Card.Title>
                            <Card.Text className="text-muted">Users</Card.Text>
                            <Button variant="outline-danger" size="sm" onClick={fetchUsers} className="mt-2 admin-btn">View Users</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={3} className="mb-3">
                    <Card className="text-center h-100 admin-card-gradient-warning border-0 shadow-lg rounded-4">
                        <Card.Body>
                            <div className="text-warning mb-2">
                                <i className="bi bi-exclamation-triangle-fill" style={{ fontSize: '2.5rem' }}></i>
                            </div>
                            <Card.Title className="h2 text-warning fw-bold">{summary?.alertCount}</Card.Title>
                            <Card.Text className="text-muted">Alerts</Card.Text>
                            <Button variant="outline-warning" size="sm" onClick={fetchAlerts} className="mt-2 admin-btn">View Alerts</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={3} className="mb-3">
                    <Card className="text-center h-100 admin-card-gradient-primary border-0 shadow-lg rounded-4">
                        <Card.Body>
                            <div className="text-primary mb-2">
                                <i className="bi bi-hand-thumbs-up-fill" style={{ fontSize: '2.5rem' }}></i>
                            </div>
                            <Card.Title className="h2 text-primary fw-bold">{summary?.helpRequestCount}</Card.Title>
                            <Card.Text className="text-muted">Help Requests</Card.Text>
                            <Button variant="outline-primary" size="sm" onClick={fetchHelpRequests} className="mt-2 admin-btn">View Help Requests</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={3} className="mb-3">
                    <Card className="text-center h-100 admin-card-gradient-success border-0 shadow-lg rounded-4">
                        <Card.Body>
                            <div className="text-success mb-2">
                                <i className="bi bi-currency-rupee" style={{ fontSize: '2.5rem' }}></i>
                            </div>
                            <Card.Title className="h2 text-success fw-bold">?{totalDonations.toLocaleString()}</Card.Title>
                            <Card.Text className="text-muted">Total Donations</Card.Text>
                            <Button variant="outline-success" size="sm" onClick={fetchDonations} className="mt-2 admin-btn">View Donations</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col md={3} className="mb-3">
                    <Card className="text-center h-100 admin-card-gradient-info border-0 shadow-lg rounded-4">
                        <Card.Body>
                            <div className="text-info mb-2">
                                <i className="bi bi-people" style={{ fontSize: '2.5rem' }}></i>
                            </div>
                            <Card.Title className="h2 text-info fw-bold">{summary?.teamCount}</Card.Title>
                            <Card.Text className="text-muted">Response Teams</Card.Text>
                            <Button variant="outline-info" size="sm" onClick={fetchTeamsModal} className="mt-2 admin-btn">View Response Teams</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
